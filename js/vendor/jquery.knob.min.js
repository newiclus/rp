(function(h){var f,l,m,j=Math.max,k=Math.min;f={};f.d=h(document);f.t=function(a){return a.originalEvent.touches.length-1};l=function(){var a=this;this.cv=this.v=this.g=this.i=this.$=this.o=null;this.y=this.x=0;this.c=this.$c=null;this.t=0;this.isInit=!1;this.rH=this.eH=this.cH=this.dH=this.pColor=this.fgColor=null;this.run=function(){var b=function(b,d){for(var e in d)a.o[e]=d[e];a.init();a._configure()._draw()};if(!this.$.data("kontroled"))return this.$.data("kontroled",!0),this.extend(),this.o=
